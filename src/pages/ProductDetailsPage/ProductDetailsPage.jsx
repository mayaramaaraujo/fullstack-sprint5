        ...
        <Detail>
          ...
          <ProductBuyBox>
            <ProductDescription>
              ...
              <div>
                {isFavorite ? (
                  <Favorite onClick={() => setIsFavorite(!isFavorite)} />
                ) : (
                  <FavoriteBorder onClick={() => setIsFavorite(!isFavorite)} />
                )}
                <ShareProduct />
              </div>
            </ProductDescription>
            ...
            <BuyCard>
              <SoldBy>
                ...
                <SoldByLink href="https://www.riachuelo.com.br/">
                  RCHLO
                </SoldByLink>
              </SoldBy>
              <PriceCard>
